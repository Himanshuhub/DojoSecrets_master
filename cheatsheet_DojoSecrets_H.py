...
$ django-admin startproject DojoSecrets_master #creates the django project
$ cd DojoSecrets_master
$ mkdir apps
$ cd apps
$ touch __init__.py  #makes the __init__.py file
$ python ../manage.py startapp login #notice that this is login and not DojoSecrets_master

$ cd login
$ touch urls.py # make /apps/login/urls.py
$ mkdir templates
$ mkdir static
$ mkdir templates/login
$ touch templates/login/index.html
#also add any html files you want i.e. touch templates/login/index.html
